$(document).ready(function() {
    ...
    $('.model-popup-chat').on('click', function () {
        var idUser = "chat-"+this.getAttribute("id");
        $('.modal-popup-chat').removeClass('d-block');
        document.getElementById(idUser).classList.add('d-block');
        return false;
    });
