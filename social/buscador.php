            ...
            <div class="middle-sidebar-left">
                ...
                <div class="row feed-body">
                    <div class="col-xl-8 col-xxl-9 col-lg-8">
                        ...
                        $me = $_SESSION["userID"];
                        $query = "SELECT * FROM `users` WHERE `nombre` LIKE '$SearchUser' or `username` LIKE '$SearchUser' AND `id` != '$me'; ";
                        $usuariosEncontrados = $db->query($query);
                        if ($usuariosEncontrados) {
                            while ($usersFetch = mysqli_fetch_array($usuariosEncontrados)) {

                                ?>
                                <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                                    <div class="card-body p-0 d-flex">
                                        <figure class="avatar me-3"><img style="width:45px;height: 45px; object-fit: cover;" src=
                                            <?php $user->getUserImage($usersFetch["id"], $db) ?> alt="image" class="shadow-sm rounded-circle w45"></figure>
                                        <!-- Ultima conexion-->
                                        <a href="http://localhost/winks/social/user-page.php?user=<?php echo $usersFetch["username"]; ?>">
                                            <h4 class="fw-700 text-grey-900 font-xssss mt-1"> <?php echo $usersFetch["nombre"]; ?>
                                                <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">@<?php echo $usersFetch["username"]; ?></span>
                                            </h4></a>
                                        <!--Nombre-->
